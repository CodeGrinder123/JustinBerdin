<template>
    ...
    <div class="h-screen">
        <div class="bg-fixed bg-cover h-80 w-38 my-bg-kazi"></div>
        <div class="mt-20 ms-20 me-20 mb-10">
            <div class="grid grid-cols-1 md:grid-cols-1 md:grid-flow-col gap-4">
                <div class="mb-5">
                    <h1 class="my-heading text-left text-4xl font-bold">KAZI:</h1>
                    <h1 class="my-heading text-3xl font-bold text-black">An Interactive Booking System</h1>
                    <p class="block text-justify text-black mt-5 mb-8">
                        KAZI is a reservation system that enables students, faculty, and staff to easily reserve and 
                        manage various spaces on campus. It emphasizes the importance of accuracy and organization in 
                        documenting and communicating reservations. This centralized platform allows users to check 
                        availability, book venues, and receive confirmation. By adopting a "kazi" perspective, 
                        administrators prioritize efficiency, structure, and attention to detail, ensuring smooth 
                    ...
                    <div class="text-center">
                        ...
                        <ul class="grid grid-cols-3 md:grid-cols-10 md:grid-flow-col gap-4 place-content-center">
                            ...
                            <li>
                                ...
                                <span class="mt-2 text-sm">Boostrap</span>
                            </li>
                            <li>
                                <div class="flex flex-col items-center">
...
<style>
.my-bg-kazi{
    background-image: url('../assets/images/jpg/KAZI_page.jpg');
